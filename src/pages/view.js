      ...
      <TableContainer component={Paper}>
        <Box >
          <Box sx={{ padding: "10px" }}>
            ...
            <Box sx={{ padding: "10px" }}>
              <SmButtton label="Refresh" onClick={DataRefresh} sx={{ textDecoration: "none" }} />
            </Box>
          </Box>
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="justify"><Typography>ID CARD</Typography></StyledTableCell>
                ...
                <StyledTableCell align="justify">
                  <Box sx={{ display: "flex" }}>
                    <Box sx={{ padding: "10px" }}>
                      ...
                      <SmButtton onClick={() => IdCard(e.id)} label='Generate' color="primary" />
                ...
                <StyledTableCell align="justify">
                  <Box sx={{ display: "flex" }}>
                    <Box sx={{ padding: "10px" }}>
                      ...
                      <SmButtton onClick={() => EditData(e.id)} label='Edit ' color="success" />
